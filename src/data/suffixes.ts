 ...
 *
 * `suffixes` here is the **connector-joined** subset: the entries a post-MVS
 * letter run may legitimately be. The package also ships
 * `spaceParticles` — the words that follow a plain space and must
